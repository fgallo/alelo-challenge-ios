...
class RemoteProductsLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteProductsLoader, toCompleteWithError error: RemoteProductsLoader.Error, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
